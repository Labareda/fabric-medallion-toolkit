...
# before calling fmt.land_records().
#
# Attach the Bronze, Silver, and Config lakehouses to this notebook, plus
# the env_medallion_toolkit Environment -- no %pip install needed, the
# wheel is already available once that Environment is attached.
